...
\newcommand{\mycbox}[1]{\begin{tcolorbox}[enhanced jigsaw,size=tight,hbox,boxsep=4pt,boxrule=2pt,coltext=black,colframe=col1light,colback=col1,opacityback=0.8,opacityframe=1]
\strut #1
\end{tcolorbox}}
%---
...
\vspace{3em}
\mycbox{\minibox{We establish sufficient conditions for polynomial-time and fast mixing\\of the Gibbs sampler on PSMs.}}
\end{frame}
